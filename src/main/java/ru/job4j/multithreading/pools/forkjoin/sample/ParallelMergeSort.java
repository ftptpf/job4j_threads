package ru.job4j.multithreading.pools.forkjoin.sample;

import java.util.concurrent.ForkJoinPool;
import java.util.concurrent.RecursiveTask;

/**
 * Реализуем рекурсивную сортировку слиянием (merge sort) с использованием пула.
 * Когда нужно возвращать отсортированную часть массива, используем RecursiveTask.
 */
